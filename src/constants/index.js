...
export const workExperiences = [
  {
    ...
    pos: 'Trade from anywhere with responsive design.',
    duration: '2024 Feb  - 2024 April',
    title: " A dynamic interface showing real-time price updates, currency movements, and trade execution features for efficient forex market participation.",
    icon: '/assets/trade5.png',
    animation: 'victory',
  },
  {
    id: 2,
    name: 'MetaTrader Integration',
    pos: 'Execute trades via MT4/MT5 AP',
    duration: '2024 April  - 2024 July',
    title: " A dynamic interface showing real-time price updates, currency movements, and trade execution features for efficient forex market participation.",
    icon: '/assets/trade6.png',
    animation: 'clapping',
  },
  {
    id: 3,
    name: 'Strategy Backtesting Module',
    pos: 'Test your trading ideas with historical data.',
    duration: '2023 - 2024',
    title: " A dynamic interface showing real-time price updates, currency movements, and trade execution features for efficient forex market participation.",
    icon: '/assets/trade5.png',
    animation: 'salute',
    ...
    pos: 'Visualize trends using charts and indicators.',
    duration: '2024 April  - 2024 July',
    title: " A dynamic interface showing real-time price updates, currency movements, and trade execution features for efficient forex market participation.",
    icon: '/assets/trade6.png',
    animation: 'clapping',
    ...
    {
    id: 5,
    name: 'Real-Time Forex Dashboard',
    pos: 'Monitor live currency prices and trade instantly.',
    duration: '2024 April  - 2024 July',
    title: " A dynamic interface showing real-time price updates, currency movements, and trade execution features for efficient forex market participation.",
    icon: '/assets/trade5.png',
    animation: 'clapping',
