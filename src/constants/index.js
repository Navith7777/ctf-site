...
export const workExperiences = [
  {
    id: 1,
    name: '.Net MVC Development',
    pos: 'Junior Web Developer',
    duration: '2024 Feb  - 2024 April',
    title: "I developed the Wizbees website as part of my internship at Wizbees Technologies Private Limited. My responsibilities included designing t user interface, implementing responsive web designs using HTML, CSS, Bootstrap, and ensuring functionality through JavaScript and backend  integration with .NET MVC.",
  ...
  },
  {
    ...
    title: "Designed and developed the website's front-end using HTML, CSS, Bootstrap, and JavaScript.Focused on creating a visually appealing and userfriendly interface with a responsive design to ensure accessibility across various devices.",
